...
const recentPurchases = [
  { name: "Chicken Breast", category: "Meat", purchaseDate: "2 days ago", price: 6.99 },
  { name: "Broccoli", category: "Vegetables", purchaseDate: "3 days ago", price: 2.99 },
  { name: "Rice", category: "Grains", purchaseDate: "1 week ago", price: 2.49 },
  { name: "Olive Oil", category: "Cooking", purchaseDate: "1 week ago", price: 4.99 },
  { name: "Onions", category: "Vegetables", purchaseDate: "4 days ago", price: 1.99 },
  { name: "Garlic", category: "Vegetables", purchaseDate: "5 days ago", price: 0.99 },
  { name: "Soy Sauce", category: "Condiments", purchaseDate: "2 weeks ago", price: 2.99 },
  { name: "Bell Peppers", category: "Vegetables", purchaseDate: "3 days ago", price: 3.49 },
]
...
const suggestedRecipes = [
  {
    ...
    difficulty: "Easy",
    rating: 4.5,
    tags: ["Quick to Cook", "Healthy"],
    availableIngredients: ["Chicken Breast", "Broccoli", "Bell Peppers", "Soy Sauce", "Garlic", "Onions"],
    missingIngredients: [],
  ...
  },
  {
    ...
    difficulty: "Easy",
    rating: 4.3,
    tags: ["Quick to Cook", "Budget-friendly"],
    availableIngredients: ["Rice", "Garlic", "Onions", "Soy Sauce"],
    missingIngredients: ["Eggs - $2.49"],
    description: "Simple fried rice with aromatic garlic flavor",
  },
  {
    ...
    availableIngredients: ["Broccoli", "Bell Peppers", "Onions", "Garlic", "Olive Oil"],
    missingIngredients: ["Zucchini - $2.99", "Cherry Tomatoes - $3.49"],
    description: "Colorful roasted vegetables with Mediterranean herbs",
  },
]
