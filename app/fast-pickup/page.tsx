...
const suggestedAddOns = [
  {
    ...
    name: "Chicken Legs",
    price: 249.0,
    image: "/items/fresh-raw-chicken-legs-cutting-board-23176294.webp",
    reason: "Frequently used in chicken curry",
    rating: 4.8,
    tag: "🍗 Tender & juicy",
  },
  {
    ...
    price: 45.0,
    image: "/items/kashmiri_chilli.jpg",
    reason: "Gives rich color & mild heat",
    rating: 4.6,
    tag: "🌶️ Vibrant red hue",
  },
  {
    id: "addon3",
    name: "Ginger Garlic Paste",
    price: 30.0,
    image: "/items/ginger-garlic.jpg",
    reason: "Essential for marinades",
    rating: 4.7,
    tag: "🧄 Aromatic base",
  },
  {
    ...
    name: "Tomatoes",
    price: 25.0,
    image: "/items/Tomato_je.jpg",
    reason: "Used for gravy",
    rating: 4.4,
    tag: "🍅 Tangy & fresh",
  },
  {
    ...
    name: "Garam Masala",
    price: 60.0,
    image: "/items/garam.jpg",
    reason: "Adds warmth & depth",
    rating: 4.6,
    tag: "🧂 Classic spice mix",
  },
  {
    id: "addon6",
    name: "Fresh Coriander Leaves",
    price: 15.0,
    image: "/items/corriander.jpg",
    reason: "Perfect for garnish",
    rating: 4.5,
    tag: "🌿 Finishing touch",
  },
]
